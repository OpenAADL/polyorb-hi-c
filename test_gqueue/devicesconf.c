...
__po_hi_c_ip_conf_t pohidrv_device_c = { .devname = "eth0", .address = "127.0.0.1", .version = __po_hi_c_ipv4, .port = 1236};
__po_hi_c_ip_conf_t pohidrv_device_d = { .devname = "eth0", .address = "127.0.0.1", .version = __po_hi_c_ipv4, .port = 1237};
