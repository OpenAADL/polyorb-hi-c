...
CTAGS = ctags
CSCOPE = cscope
am__DIST_COMMON = $(srcdir)/Makefile.in $(top_srcdir)/support/compile \
	$(top_srcdir)/support/config.guess \
	$(top_srcdir)/support/config.sub \
	$(top_srcdir)/support/install-sh $(top_srcdir)/support/missing \
	AUTHORS
...
TEXI2HTML = 
VERSION = 2017.x
abs_builddir = /home/francis/polyorb-hi-c
abs_srcdir = /home/francis/polyorb-hi-c
