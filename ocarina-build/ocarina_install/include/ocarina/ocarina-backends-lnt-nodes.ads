...
package Ocarina.Backends.LNT.Nodes is
   ...
   function Is_Not_Periodic (N : Node_Id) return Boolean;
   procedure Set_Is_Not_Periodic (N : Node_Id; V : Boolean);
