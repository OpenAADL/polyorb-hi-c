...
package body Ocarina.Backends.Ada_Tree.Nodes is
   ...
   begin
      pragma Assert (False
        ...
        or else Table (Types.Node_Id (N)).Kind = K_Aspect_Specification
        or else Table (Types.Node_Id (N)).Kind = K_Aspect
        or else Table (Types.Node_Id (N)).Kind = K_Pre_Definition
        or else Table (Types.Node_Id (N)).Kind = K_Global_Specification
        or else Table (Types.Node_Id (N)).Kind = K_Moded_Global_List
        or else Table (Types.Node_Id (N)).Kind = K_Initialization_Spec
        or else Table (Types.Node_Id (N)).Kind = K_Initialization_List
        or else Table (Types.Node_Id (N)).Kind = K_Abstract_State_List
        or else Table (Types.Node_Id (N)).Kind = K_State_Name_With_Option
        or else Table (Types.Node_Id (N)).Kind = K_Refinement_List
        or else Table (Types.Node_Id (N)).Kind = K_Refinement_Clause
   ...
   function Aspect_Specification (N : Node_Id) return Node_Id is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Package_Specification
        or else Table (Types.Node_Id (N)).Kind = K_Package_Implementation
   ...
   procedure Set_Aspect_Specification (N : Node_Id; V : Node_Id) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Package_Specification
        or else Table (Types.Node_Id (N)).Kind = K_Package_Implementation
   ...
   function Aspect (N : Node_Id) return List_Id is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Aspect_Specification);
   ...
   procedure Set_Aspect (N : Node_Id; V : List_Id) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Aspect_Specification);
   ...
   function Aspect_Mark (N : Node_Id) return Name_Id is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Aspect);
   ...
   procedure Set_Aspect_Mark (N : Node_Id; V : Name_Id) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Aspect);
   ...
   function Aspect_Definition (N : Node_Id) return Node_Id is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Aspect);
   ...
   procedure Set_Aspect_Definition (N : Node_Id; V : Node_Id) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Aspect);

      Table (Types.Node_Id (N)).L (2) := Int (V);
   end Set_Aspect_Definition;

   function Subprogram_Call (N : Node_Id) return Node_Id is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Pre_Definition);
   ...
   procedure Set_Subprogram_Call (N : Node_Id; V : Node_Id) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Pre_Definition);
   ...
   function Moded_Global_List (N : Node_Id) return List_Id is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Global_Specification);

      return List_Id (Table (Types.Node_Id (N)).L (1));
   end Moded_Global_List;

   procedure Set_Moded_Global_List (N : Node_Id; V : List_Id) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Global_Specification);

      Table (Types.Node_Id (N)).L (1) := Int (V);
   end Set_Moded_Global_List;

   function Mode_Selector (N : Node_Id) return Mode_Id is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Moded_Global_List);
   ...
   procedure Set_Mode_Selector (N : Node_Id; V : Mode_Id) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Moded_Global_List);

      Table (Types.Node_Id (N)).O (1) := Byte (V);
   end Set_Mode_Selector;

   function Initialization_List (N : Node_Id) return List_Id is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Initialization_Spec);

      return List_Id (Table (Types.Node_Id (N)).L (1));
   end Initialization_List;

   procedure Set_Initialization_List (N : Node_Id; V : List_Id) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Initialization_Spec);

      Table (Types.Node_Id (N)).L (1) := Int (V);
   end Set_Initialization_List;

   function State_Name_With_Option (N : Node_Id) return List_Id is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Abstract_State_List);

      return List_Id (Table (Types.Node_Id (N)).L (1));
   end State_Name_With_Option;

   procedure Set_State_Name_With_Option (N : Node_Id; V : List_Id) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Abstract_State_List);

      Table (Types.Node_Id (N)).L (1) := Int (V);
   end Set_State_Name_With_Option;

   function Synchronous (N : Node_Id) return Boolean is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_State_Name_With_Option);
   ...
   procedure Set_Synchronous (N : Node_Id; V : Boolean) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_State_Name_With_Option);
   ...
   function External (N : Node_Id) return Boolean is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_State_Name_With_Option);
   ...
   procedure Set_External (N : Node_Id; V : Boolean) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_State_Name_With_Option);
   ...
   function Refinement_Clause (N : Node_Id) return List_Id is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Refinement_List);

      return List_Id (Table (Types.Node_Id (N)).L (1));
   end Refinement_Clause;

   procedure Set_Refinement_Clause (N : Node_Id; V : List_Id) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Refinement_List);

      Table (Types.Node_Id (N)).L (1) := Int (V);
   end Set_Refinement_Clause;

   function State_Name (N : Node_Id) return Node_Id is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Refinement_Clause);
   ...
   procedure Set_State_Name (N : Node_Id; V : Node_Id) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Refinement_Clause);
   ...
   function Constituent (N : Node_Id) return List_Id is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Refinement_Clause);
   ...
   procedure Set_Constituent (N : Node_Id; V : List_Id) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Refinement_Clause);
      ...
      case Kind (N) is
         ...
         when K_Main_Subprogram_Implementation =>
            W_Main_Subprogram_Implementation
              (Node_Id (N));
         when K_Aspect_Specification =>
            W_Aspect_Specification
              (Node_Id (N));
         when K_Aspect =>
            W_Aspect
              (Node_Id (N));
         when K_Pre_Definition =>
            W_Pre_Definition
              (Node_Id (N));
         when K_Global_Specification =>
            W_Global_Specification
              (Node_Id (N));
         when K_Moded_Global_List =>
            W_Moded_Global_List
              (Node_Id (N));
         when K_Initialization_Spec =>
            W_Initialization_Spec
              (Node_Id (N));
         when K_Initialization_List =>
            W_Initialization_List
              (Node_Id (N));
         when K_Abstract_State_List =>
            W_Abstract_State_List
              (Node_Id (N));
         when K_State_Name_With_Option =>
            W_State_Name_With_Option
              (Node_Id (N));
         when K_Refinement_List =>
            W_Refinement_List
              (Node_Id (N));
         when K_Refinement_Clause =>
            W_Refinement_Clause
              (Node_Id (N));
         when K_Packages =>
            W_Packages
   ...
   begin
      ...
      W_Node_Attribute
        ("Aspect_Specification",
         "Node_Id",
         Image (Aspect_Specification (N)),
         Int (Aspect_Specification (N)));
      W_Node_Attribute
        ("Visible_Part",
         "List_Id",
   ...
   procedure W_Aspect_Specification (N : Node_Id) is
   begin
      W_Node_Header
        (Node_Id (N));
      W_Node_Attribute
      ...
      W_Node_Attribute
        ("Aspect",
         ...
         Image (Aspect (N)),
         Int (Aspect (N)));
   end W_Aspect_Specification;

   procedure W_Aspect (N : Node_Id) is
   begin
      W_Node_Header
        (Node_Id (N));
      W_Node_Attribute
      ...
      W_Node_Attribute
        ("Aspect_Definition",
         "Node_Id",
         Image (Aspect_Definition (N)),
         Int (Aspect_Definition (N)));
   end W_Aspect;

   procedure W_Pre_Definition (N : Node_Id) is
   begin
      W_Node_Header
        (Node_Id (N));
      W_Node_Attribute
      ...
      W_Node_Attribute
        ("Subprogram_Call",
         "Node_Id",
         Image (Subprogram_Call (N)),
         Int (Subprogram_Call (N)));
   end W_Pre_Definition;

   procedure W_Global_Specification (N : Node_Id) is
   begin
      W_Node_Header
        (Node_Id (N));
      W_Node_Attribute
      ...
      W_Node_Attribute
        ("Moded_Global_List",
         "List_Id",
         Image (Moded_Global_List (N)),
         Int (Moded_Global_List (N)));
   end W_Global_Specification;

   procedure W_Moded_Global_List (N : Node_Id) is
   begin
      W_Node_Header
        (Node_Id (N));
      W_Node_Attribute
      ...
      W_Node_Attribute
        ("Mode_Selector",
         "Mode_Id",
         Image (Mode_Selector (N)));
   end W_Moded_Global_List;

   procedure W_Initialization_Spec (N : Node_Id) is
   begin
      W_Node_Header
        (Node_Id (N));
      W_Node_Attribute
      ...
      W_Node_Attribute
        ("Initialization_List",
         "List_Id",
         Image (Initialization_List (N)),
         Int (Initialization_List (N)));
   end W_Initialization_Spec;

   procedure W_Initialization_List (N : Node_Id) is
   begin
      W_Node_Header
        (Node_Id (N));
      W_Node_Attribute
      ...
      W_Node_Attribute
        ("Defining_Identifier",
         ...
         Image (Defining_Identifier (N)),
         Int (Defining_Identifier (N)));
   end W_Initialization_List;

   procedure W_Abstract_State_List (N : Node_Id) is
   begin
      W_Node_Header
        (Node_Id (N));
      W_Node_Attribute
      ...
      W_Node_Attribute
        ("Frontend_Node",
         ...
         Int (Frontend_Node (N)));
      W_Node_Attribute
        ("State_Name_With_Option",
         "List_Id",
         Image (State_Name_With_Option (N)),
         Int (State_Name_With_Option (N)));
   end W_Abstract_State_List;

   procedure W_State_Name_With_Option (N : Node_Id) is
   begin
      W_Node_Header
        (Node_Id (N));
      W_Node_Attribute
      ...
      W_Node_Attribute
        ("External",
         "Boolean",
         Image (External (N)));
   end W_State_Name_With_Option;

   procedure W_Refinement_List (N : Node_Id) is
   begin
      W_Node_Header
        (Node_Id (N));
      W_Node_Attribute
      ...
      W_Node_Attribute
        ("Refinement_Clause",
         "List_Id",
         Image (Refinement_Clause (N)),
         Int (Refinement_Clause (N)));
   end W_Refinement_List;

   procedure W_Refinement_Clause (N : Node_Id) is
   begin
      W_Node_Header
        (Node_Id (N));
      W_Node_Attribute
