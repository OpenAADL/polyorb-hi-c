...
package body Ocarina.Backends.LNT.Nodes is
   ...
   begin
      pragma Assert (False
        ...
        or else Table (Types.Node_Id (N)).Kind = K_Length
        or else Table (Types.Node_Id (N)).Kind = K_Append
        or else Table (Types.Node_Id (N)).Kind = K_Head
        or else Table (Types.Node_Id (N)).Kind = K_Tail
        or else Table (Types.Node_Id (N)).Kind = K_Reverse
   ...
   function Is_Not_Periodic (N : Node_Id) return Boolean is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Process_Instantiation_Statement);
   ...
   procedure Set_Is_Not_Periodic (N : Node_Id; V : Boolean) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Process_Instantiation_Statement);

      Table (Types.Node_Id (N)).B (1) := Boolean (V);
   end Set_Is_Not_Periodic;
   ...
   procedure W_Length (N : Node_Id) is
   begin
      W_Node_Header
        (Node_Id (N));
      W_Node_Attribute
   ...
   procedure W_Append (N : Node_Id) is
   begin
      W_Node_Header
        (Node_Id (N));
      W_Node_Attribute
   ...
   procedure W_Reverse (N : Node_Id) is
   begin
      W_Node_Header
        (Node_Id (N));
      W_Node_Attribute
