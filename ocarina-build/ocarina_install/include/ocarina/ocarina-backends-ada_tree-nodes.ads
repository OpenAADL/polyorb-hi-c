...
package Ocarina.Backends.Ada_Tree.Nodes is
   ...
   type Node_Kind is
     (K_Node_Id,
      ...
      K_Aspect_Specification,
      K_Aspect,
      K_Pre_Definition,
      K_Global_Specification,
      K_Moded_Global_List,
      K_Initialization_Spec,
      K_Initialization_List,
      K_Abstract_State_List,
      K_State_Name_With_Option,
      K_Refinement_List,
      K_Refinement_Clause,
      K_Packages,
   ...
   procedure W_Aspect_Specification (N : Node_Id);
   ...
   --    Frontend_Node            : Node_Id
   --    Aspect_Mark              : Name_Id
   --    Aspect_Definition        : Node_Id
   --

   procedure W_Aspect (N : Node_Id);
   ...
   procedure W_Pre_Definition (N : Node_Id);
   ...
   procedure W_Global_Specification (N : Node_Id);
   ...
   procedure W_Moded_Global_List (N : Node_Id);
   ...
   --    Next_Node                : Node_Id
   --    Frontend_Node            : Node_Id
   --    Initialization_List      : List_Id
   --

   procedure W_Initialization_Spec (N : Node_Id);
   ...
   procedure W_Initialization_List (N : Node_Id);
   ...
   --    Next_Node                : Node_Id
   --    Frontend_Node            : Node_Id
   --    State_Name_With_Option   : List_Id
   --

   procedure W_Abstract_State_List (N : Node_Id);
   ...
   procedure W_State_Name_With_Option (N : Node_Id);
   ...
   --    Next_Node                : Node_Id
   --    Frontend_Node            : Node_Id
   --    Refinement_Clause        : List_Id
   --

   procedure W_Refinement_List (N : Node_Id);
   ...
   procedure W_Refinement_Clause (N : Node_Id);
   ...
   function Aspect_Specification (N : Node_Id) return Node_Id;
   procedure Set_Aspect_Specification (N : Node_Id; V : Node_Id);
   ...
   function Aspect (N : Node_Id) return List_Id;
   procedure Set_Aspect (N : Node_Id; V : List_Id);

   function Aspect_Mark (N : Node_Id) return Name_Id;
   procedure Set_Aspect_Mark (N : Node_Id; V : Name_Id);

   function Aspect_Definition (N : Node_Id) return Node_Id;
   procedure Set_Aspect_Definition (N : Node_Id; V : Node_Id);

   function Subprogram_Call (N : Node_Id) return Node_Id;
   procedure Set_Subprogram_Call (N : Node_Id; V : Node_Id);

   function Moded_Global_List (N : Node_Id) return List_Id;
   procedure Set_Moded_Global_List (N : Node_Id; V : List_Id);

   function Mode_Selector (N : Node_Id) return Mode_Id;
   procedure Set_Mode_Selector (N : Node_Id; V : Mode_Id);

   function Initialization_List (N : Node_Id) return List_Id;
   procedure Set_Initialization_List (N : Node_Id; V : List_Id);

   function State_Name_With_Option (N : Node_Id) return List_Id;
   procedure Set_State_Name_With_Option (N : Node_Id; V : List_Id);

   function Synchronous (N : Node_Id) return Boolean;
   procedure Set_Synchronous (N : Node_Id; V : Boolean);

   function External (N : Node_Id) return Boolean;
   procedure Set_External (N : Node_Id; V : Boolean);

   function Refinement_Clause (N : Node_Id) return List_Id;
   procedure Set_Refinement_Clause (N : Node_Id; V : List_Id);

   function State_Name (N : Node_Id) return Node_Id;
   procedure Set_State_Name (N : Node_Id; V : Node_Id);

   function Constituent (N : Node_Id) return List_Id;
   procedure Set_Constituent (N : Node_Id; V : List_Id);
